...
import {GetUsefulLinkByIdQuery} from "./queries/get-useful-link-by-id/get-useful-link-by-id.query";
...
export class UsefulLinksController {
    ...
    async getById(@Param('id', ParseIntPipe) id: number) {
        return await this.queryBus.execute(new GetUsefulLinkByIdQuery(id));
    }
